...
use Site\BackOfficeBundle\Form\CategoriesType;
...
class CategoriesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SiteBackOfficeBundle:Categories')->findAll();

        return $this->render('SiteBackOfficeBundle:Categories:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SiteBackOfficeBundle:Categories:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SiteBackOfficeBundle:Categories')->find($id);
        ...
        return $this->render('SiteBackOfficeBundle:Categories:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SiteBackOfficeBundle:Categories:edit.html.twig', array(
            'entity'      => $entity,
