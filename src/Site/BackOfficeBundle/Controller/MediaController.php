...
class MediaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SiteBackOfficeBundle:Media')->findAll();

        return $this->render('SiteBackOfficeBundle:Media:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SiteBackOfficeBundle:Media')->find($id);
        ...
        return $this->render('SiteBackOfficeBundle:Media:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SiteBackOfficeBundle:Media:edit.html.twig', array(
            'entity'      => $entity,
