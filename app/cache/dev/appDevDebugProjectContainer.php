...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'pricepromo' => 'getPricepromoService',
            'profiler' => 'getProfilerService',
            'profiler_listener' => 'getProfilerListenerService',
            'promoproduct' => 'getPromoproductService',
            'property_accessor' => 'getPropertyAccessorService',
            'redirectlistener' => 'getRedirectlistenerService',
            'refusedlistener' => 'getRefusedlistenerService',
            ...
            'site_utilisateurs.registration.form.type' => 'getSiteUtilisateurs_Registration_Form_TypeService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SiteFrontOfficeBundle', ($this->targetDirs[2].'/Resources/SiteFrontOfficeBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SiteFrontOfficeBundle', ($this->targetDirs[3].'\\src\\Site\\FrontOfficeBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'ecommerce', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $c, $f, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $c->addDriver($b, 'Site\\UtilisateursBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('GedmoTranslatable' => 'Gedmo\\Translatable\\Entity', 'GedmoTranslator' => 'Gedmo\\Translator\\Entity', 'GedmoLoggable' => 'Gedmo\\Loggable\\Entity', 'GedmoTree' => 'Gedmo\\Tree\\Entity', 'SiteBackOfficeBundle' => 'Site\\BackOfficeBundle\\Entity', 'SiteUtilisateursBundle' => 'Site\\UtilisateursBundle\\Entity'));
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.request', array(0 => 'refusedlistener', 1 => 'onKernelRequest'), 0);
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '0943bcfc5110c684c8bee424b72de17bd');
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Site\\UtilisateursBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Site\\UtilisateursBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'site_utilisateurs_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Site\\UtilisateursBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Site\\UtilisateursBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Site\\UtilisateursBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'pricepromo' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Site\FrontOfficeBundle\Twig\Extension\PriceSoldeExtension A Site\FrontOfficeBundle\Twig\Extension\PriceSoldeExtension instance.
     */
    protected function getPricepromoService()
    {
        return $this->services['pricepromo'] = new \Site\FrontOfficeBundle\Twig\Extension\PriceSoldeExtension($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    /**
     * Gets the 'promoproduct' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Site\FrontOfficeBundle\Services\PromoProduct A Site\FrontOfficeBundle\Services\PromoProduct instance.
     */
    protected function getPromoproductService()
    {
        return $this->services['promoproduct'] = new \Site\FrontOfficeBundle\Services\PromoProduct($this->get('doctrine.orm.default_entity_manager'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Site\FrontOfficeBundle\Listener\RedirectListener A Site\FrontOfficeBundle\Listener\RedirectListener instance.
     */
    protected function getRedirectlistenerService()
    {
        return $this->services['redirectlistener'] = new \Site\FrontOfficeBundle\Listener\RedirectListener($this, $this->get('session'));
    }

    /**
     * Gets the 'refusedlistener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Site\FrontOfficeBundle\Listener\RefusedListner A Site\FrontOfficeBundle\Listener\RefusedListner instance.
     */
    protected function getRefusedlistenerService()
    {
        return $this->services['refusedlistener'] = new \Site\FrontOfficeBundle\Listener\RefusedListner($this, $this->get('session'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($d, array('default_target_path' => '/checkout', 'always_use_default_target_path' => false, 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $g->setProviderKey('main');

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username_email')), 'main', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'main', $g, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $b), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '55a1ab8ebf4ed', $b), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
    ...
    /**
     * Gets the 'site_utilisateurs.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Site\UtilisateursBundle\Form\Type\RegistrationFormType A Site\UtilisateursBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getSiteUtilisateurs_Registration_Form_TypeService()
    {
        return $this->services['site_utilisateurs.registration.form.type'] = new \Site\UtilisateursBundle\Form\Type\RegistrationFormType('Site\\UtilisateursBundle\\Entity\\User');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Site\\BackOfficeBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Site\\FrontOfficeBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Site\\UtilisateursBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'SiteFrontOfficeBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
        $instance->addExtension(new \Doctrine\Bundle\DoctrineBundle\Twig\DoctrineExtension());
        $instance->addExtension($this->get('pricepromo'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Site\\BackOfficeBundle/Resources/views'), 'SiteBackOffice');
        $instance->addPath(($this->targetDirs[3].'\\src\\Site\\FrontOfficeBundle/Resources/views'), 'SiteFrontOffice');
        $instance->addPath(($this->targetDirs[2].'/Resources/FOSUserBundle/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Site\\UtilisateursBundle/Resources/views'), 'SiteUtilisateurs');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0943bcfc5110c684c8bee424b72de17bd');
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/confirm'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/confirmTwo'), array(0 => 'ROLE_USER'), NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SiteUtilisateursBundle' => 'Site\\UtilisateursBundle\\SiteUtilisateursBundle',
            ...
            'locale' => 'en',
            'secret' => '0943bcfc5110c684c8bee424b72de17bd',
            ...
            'kernel.secret' => '0943bcfc5110c684c8bee424b72de17bd',
            ...
            'fos_user.model.user.class' => 'Site\\UtilisateursBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'site_utilisateurs_registration',
